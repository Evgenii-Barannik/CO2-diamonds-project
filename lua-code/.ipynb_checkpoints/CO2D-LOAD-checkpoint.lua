...
--OPTIONS-- (CHECK BEFORE START)
	SpectraName = string.format("FN7114 map truncated version") --Set invariant part of spectra name (which is before number).
	...
	LastSpectrum  = 355 --Set last spectrum number.
	SpectraFolder = string.format("/Users/meguka/Dropbox/CO2D-project-github/data/FN7114 map truncated") --Set path to the spectra folder.
